...
playGame.prototype = {
    preload:function(){
  	...
  	create: function(){
        ...
        var hiScoreText = game.add.bitmapText(game.width / 2, game.height - 200, "smallfont", "BEST SCORE", 24);
        hiScoreText.anchor.set(0.5);
        this.menuGroup.add(hiScoreText);
        var hiScore = game.add.bitmapText(game.width / 2, game.height - 140, "font", this.savedData.score.toString(), 72);
